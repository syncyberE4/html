...
$stmtHaalLogboekOp = $conn->prepare(
    "SELECT l.logboek_id, l.aanmaak_datum, l.opmerkingen, v.label, d.naam, p.omschrijving, v.vat_id, l.manueel 
    FROM Logboek AS l
...
if(isset($_POST['logboekId'])) {
    ...
    if($result->num_rows > 0){
        ...
        if($resultVatSensoren->num_rows > 0){
            ...
            $stmtHaalEventsPerLogboek->bind_param("is", $logboek["vat_id"], $logboek["aanmaak_datum"]);
